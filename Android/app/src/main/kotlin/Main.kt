...
internal val logger: SkipLogger = SkipLogger(subsystem = "swift.gups", category = "SwiftGups")

private typealias AppRootView = SwiftGupsRootView
private typealias AppDelegate = SwiftGupsAppDelegate
